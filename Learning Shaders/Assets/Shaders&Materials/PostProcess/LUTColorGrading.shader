    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed4 col = saturate(tex2D(_MainTex, i.uv));//make sure between 0..1
			
				float halfColX = 0.5 / _LUT_TexelSize.z;//half texel size for percision 
				float halfColY = 0.5 / _LUT_TexelSize.w;//whilst sampling

				float threshold = maxColor / COLORS;//ensure not beyond LUT
